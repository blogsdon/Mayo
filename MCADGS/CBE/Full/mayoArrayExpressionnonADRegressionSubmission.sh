...
provenanceFile="/shared/Mayo/MCADGS/CBE/Full/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/Mayo/MCADGS/CBE/Full/Regressionerror.txt"

#path to out output
outOutput="/shared/Mayo/MCADGS/CBE/Full/Regressionout.txt"
