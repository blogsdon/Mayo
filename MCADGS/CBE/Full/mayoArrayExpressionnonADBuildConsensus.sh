...
outputpath="/local/Mayo/MCADGS/CBE/Full/"

#path within s3
s3b="Mayo/MCADGS/CBE/Full"

#id of folder with networks to combine
networkFolderId="syn5968546"
...
provenanceFile="/shared/Mayo/MCADGS/CBE/Full/provenanceFile.txt"

#path to error output
errorOutput="/shared/Mayo/MCADGS/CBE/Full/Aggregationerror.txt"

#path to out output
outOutput="/shared/Mayo/MCADGS/CBE/Full/Aggregationout.txt"
