...
provenanceFile="/shared/Mayo/MCADGS/CBE/AD/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/Mayo/MCADGS/CBE/AD/MICorerror.txt"

#path to out output
outOutput="/shared/Mayo/MCADGS/CBE/AD/MICorout.txt"

#job script name
jobname="mayocbeMICorAD"
