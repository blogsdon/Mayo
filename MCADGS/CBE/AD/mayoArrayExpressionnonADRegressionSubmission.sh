...
outputpath="/shared/Mayo/MCADGS/CBE/AD/"
...
provenanceFile="/shared/Mayo/MCADGS/CBE/AD/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/Mayo/MCADGS/CBE/AD/Regressionerror.txt"

#path to out output
outOutput="/shared/Mayo/MCADGS/CBE/AD/Regressionout.txt"

#job script name
jobname="mayocbeRegressionAD"
