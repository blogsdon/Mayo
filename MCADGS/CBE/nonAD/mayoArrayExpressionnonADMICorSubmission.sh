...
provenanceFile="/shared/Mayo/MCADGS/CBE/nonAD/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/Mayo/MCADGS/CBE/nonAD/MICorerror.txt"

#path to out output
outOutput="/shared/Mayo/MCADGS/CBE/nonAD/MICorout.txt"
