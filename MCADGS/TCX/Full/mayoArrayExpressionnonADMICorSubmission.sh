...
provenanceFile="/shared/Mayo/MCADGS/TCX/Full/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/Mayo/MCADGS/TCX/Full/MICorerror.txt"

#path to out output
outOutput="/shared/Mayo/MCADGS/TCX/Full/MICorout.txt"
