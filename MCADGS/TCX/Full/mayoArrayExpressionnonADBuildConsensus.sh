...
outputpath="/local/Mayo/MCADGS/TCX/Full/"

#path within s3
s3b="Mayo/MCADGS/TCX/Full"

#id of folder with networks to combine
networkFolderId="syn5968543"
...
provenanceFile="/shared/Mayo/MCADGS/TCX/Full/provenanceFile.txt"

#path to error output
errorOutput="/shared/Mayo/MCADGS/TCX/Full/Aggregationerror.txt"

#path to out output
outOutput="/shared/Mayo/MCADGS/TCX/Full/Aggregationout.txt"
