...
provenanceFile="/shared/Mayo/MCADGS/TCX/AD/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/Mayo/MCADGS/TCX/AD/Regressionerror.txt"

#path to out output
outOutput="/shared/Mayo/MCADGS/TCX/AD/Regressionout.txt"

#job script name
jobname="mayoTCXRegressionAD"
