...
outputpath="/local/Mayo/MCADGS/TCX/AD/"

#path within s3
s3b="Mayo/MCADGS/TCX/AD"

#id of folder with networks to combine
networkFolderId="syn5968542"
...
provenanceFile="/shared/Mayo/MCADGS/TCX/AD/provenanceFile.txt"

#path to error output
errorOutput="/shared/Mayo/MCADGS/TCX/AD/Aggregationerror.txt"

#path to out output
outOutput="/shared/Mayo/MCADGS/TCX/AD/Aggregationout.txt"

#job script name
jobname="mayoTCXaggregationAD"
