...
provenanceFile="/shared/Mayo/MCADGS/TCX/nonAD/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/Mayo/MCADGS/TCX/nonAD/MICorerror.txt"

#path to out output
outOutput="/shared/Mayo/MCADGS/TCX/nonAD/MICorout.txt"

#job script name
jobname="mayoTCXMICorControl"
